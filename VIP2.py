...
vipro = VIPRO.LINE()
vipro.login(token="EwuDzAX1HOChhzFJMivb.Sp/s6yipA4kI8lGDz1Jc/W./IDEYRL3fL3zmq9ikK8ECpVJH4UzuQa9BsSXAgUOX+U=")
vipro.loginResult()

ki = VIPRO.LINE()
ki.login(token="Ew3suxwI9rVEx3WWq3Ae.E3cvB3/EuaSbgNgItOaD+G.ziugTcQFH6jDu0raGf6h0KXJsxexB6fQLTqKdDCGtps=")
ki.loginResult()

ki2 = VIPRO.LINE()
ki2.login(token="EwavsioI4SFDbOx21Dbf.H/Mm7bFIaPhQnI/uO+q/JW.kghCbYeHl5Xgo4PNoBQT1IHiWiZagzUBxWPsgD8h3t4=")
ki2.loginResult()

ki3 = VIPRO.LINE()
ki3.login(token="EwlD4y728apTAvsp7Ry6.UNKe4wc3Vzi4au7QejJdvG.LwLRQkx6nzfjZNEW5cgTZ6FXE9ixDyaxVcuD0go4Yk0=")
ki3.loginResult()

ki4 = VIPRO.LINE()
ki4.login(token="EwYbHRSbj65mgvGm9t4e./zpGMya25+N4DDp12uoThG.en6porDjYd/tl8iyTp6cR05SSq3ByTTR5TORUVYm8oY=")
ki4.loginResult()

ki5 = VIPRO.LINE()
ki5.login(token="EwPesBWtn7rptQhB6qD5.sidob7TMb+twUwaTBGdPjq.RkbeIDb+hnrQFTGZm/2IYHolCba8RMLaV5MWcEBfZnE=")
ki5.loginResult()

ki6 = VIPRO.LINE()
ki6.login(token="EwCdMAea193gNSH6F7F6.cVv4a+phTNQfgRMhYCmA9G./QtTfiU3ERHOVZTHI99WIShSB4lEZP85QMHGU/Vj3fE=")
ki6.loginResult()
...
Bots=[mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,ki8mid,ki9mid,ki10mid,Smid,"u31d8aba9dff04c75242f2a2097b8adae"]
admin=[mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,ki8mid,ki9mid,Smid,"u31d8aba9dff04c75242f2a2097b8adae"]
creator=["u31d8aba9dff04c75242f2a2097b8adae"]
admsa=["u31d8aba9dff04c75242f2a2097b8adae"]
        ...
        if op.type == 26:
            ...
            if msg.contentType == 16:
              if wait["likeOn"] == True:
                ...
                vipro.like(url[25:58], url[66:], likeType=1003)
                owner.like(url[25:58], url[66:], likeType=1005)
                ki.like(url[25:58], url[66:], likeType=1005)
                ki2.like(url[25:58], url[66:], likeType=1005)
                ki3.like(url[25:58], url[66:], likeType=1005)
                ki4.like(url[25:58], url[66:], likeType=1005)
                ki5.like(url[25:58], url[66:], likeType=1005)
                ki6.like(url[25:58], url[66:], likeType=1005)
                ki7.like(url[25:58], url[66:], likeType=1005)
                ki8.like(url[25:58], url[66:], likeType=1005)
                ki9.like(url[25:58], url[66:], likeType=1005)
                ki10.like(url[25:58], url[66:], likeType=1005)
                owner.comment(url[25:58], url[66:], wait["comment1"])
                wait["likeOn"] = False
#-----------------------------------------------
        if op.type == 11:
            if op.param3 == '1':
                ...
                if wait['invite'] == True:
                     ...
                     for s in groups.members:
                         if _name in s.displayName:
                             vipro.sendText(msg.to, _name + " Sudah Berada DiGrup Ini")
                         else:
...
#----------------------------------------------
		    ...
		    a = msg.text.replace("Xvideos ","")
              ...
              if msg.from_ in creator + admin:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u31d8aba9dff04c75242f2a2097b8adae'}
                vipro.sendMessage(msg)
...
#--------------------------------------------------------
                    ...
                    msg.contentType = 7
                    msg.text = "aku manusia"
                    vipro.sendText(msg.to, "aku manusia")
...
#=====================================================================================   
              ...
              if msg.from_ in creator + admin:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u07abdfb9d1644326c65c13f9727b10d7'}
                vipro.sendText(msg.to,"❂•••••••••✧••••••••••❂")
                vipro.sendMessage(msg)
	        ...
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    ...
                    if len(dataResult) > 0:
                        ...
                        msg.contentType = 7
                        msg.text = ""
                        msg.contentMetadata={'STKID': '16867954',
                                            'STKPKGID': '8676',
                                            'STKVER': '3'}                                        
...
#------------------------------------------------------------
                ...
                admin6 = "u084a854a3377d1aaeefa18a2036934e0"
